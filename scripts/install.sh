...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/PastaArroz/ipv6/main/configs/3proxy.service --output-document=/usr/lib/systemd/system/3proxy.service
